...
class UI {
    static showAddressList() {
        const addAddress = Address.getAddresses()
        addAddress.forEach(address => UI.addToAddressList(address))
    }
    ...
    static showModelData(id) {
        ...
        addresses.forEach(address => {
            if (address.id == id) {
                ...
                document.getElementById('model-title').innerHTML = "Change Address Details";

                document.getElementById('model-btns').innerHTML = `
...
function eventListeners() {
    addBtn.addEventListener('click', () => {
        form.reset()
        document.getElementById('model-title').innerHTML = "Add Address"
        UI.showmodel()
        document.getElementById('model-btns').innerHTML = `
    ...
    // close add item model
    closeBtn.addEventListener('click', UI.closemodel);
    ...
    //add address item 
    modelBtns.addEventListener('click', (event) => {
        // console.log(event);
